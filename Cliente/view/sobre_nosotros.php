...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row mb-5">
            <div class="col-md-6">
                <img src="/MacaBlue/Cliente/assets/img/andrei-stan-d56QrDc_Sk0-unsplash.jpg" alt="Nuestra Tienda" class="img-fluid rounded shadow">
            </div>
            <div class="col-md-6">
        ...
        <div class="row mb-5">
            <div class="col-md-6 order-md-2">
                <img src="/MacaBlue/cliente/assets/img/austin-distel-rxpThOwuVgE-unsplash.jpg" alt="Nuestro Equipo" class="img-fluid rounded shadow">
            </div>
